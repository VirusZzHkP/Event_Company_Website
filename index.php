...
<head>
    ...
    <title>Event Page Name | ViruZzWarning</title>
...
<body>
    ...
    <header class="header">
        ...
        <a href="#" class="logo"><span>event</span> Company</a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>its time to celebrate!with the best event organizers <span> event company name </span></h3>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>Best celebration begins with us</h3>
    ...
    <section class="contact" id="contact">
        ...
        <form action="connect.php" method="post">
            <div class="inputBox">
                <input type="text" placeholder="name" id="name" for="name" name="name">
                <input type="email" placeholder="email" for="email" name="email">
            </div>
            <div class="inputBox">
                <input type="number" placeholder="number" for="number" id="number" name="number"> 
                <input type="text" placeholder="subject" name="subject" id="subject" for="subject">
            </div>
            <textarea name="message" placeholder="your message" id="message" cols="30" rows="10" for="message"></textarea>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#"> <i class="fas fa-map-marker-alt"></i> Krishnanagar </a>
                <a href="#"> <i class="fas fa-map-marker-alt"></i> Mayapur </a>
            </div>
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="tel:91-1234567890"> <i class="fas fa-phone" target="_blank"></i> +91 1234567890 </a>
                <a href="tel:91-0987654321"> <i class="fas fa-phone" target="_blank"></i> +91 0987654321 </a>
                <a href="mailto:test@test.com" style="text-transform: none;" target="_blank"> <i class="fas fa-envelope"></i> test@test.com </a>
                <a href="https://goo.gl/maps/8FpaU6zSV8AH3M9v8" target="_blank"> <i class="fas fa-map-marker-alt"></i> Haringhata,Nadia, india - 741249 </a>
            </div>

            <div class="box">
                <h3>follow us</h3>
                <a href="https://www.facebook.com/therealhrisikesh" target="_blank"> <i class="fab fa-facebook-f"></i> facebook </a>
                <a href="https://twitter.com/hrisikesh_pal" target="_blank"> <i class="fab fa-twitter"></i> twitter </a>
                <a href="https://www.instagram.com/lyadhkhor_hrisi" target="_blank"> <i class="fab fa-instagram"></i> instagram </a>
                <a href="https://www.linkedin.com/in/viruszzwarning" target="_blank"> <i class="fab fa-linkedin"></i> linkedin </a>
            </div>

        </div>

        <div class="credit"> created by : <span>Hrisikesh Pal</span>|| <span>VirusZzWarning</span> || all rights reserved </div>
